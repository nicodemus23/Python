...
########################################################################################################################################################################################
# This Python program uses PyGame with OpenGL along with pyrr, math, os, numpy and PIL for image importing. It dynamically loads textures from within the directory and renders a procedurally 
# generated sphere or cube, creates a shader program that consists of a vertex and fragment shader with uniforms sampler2D texture map calls to diffuse, roughness, emissive, glossiness, 
# metallic, normal, opacity and ambient occlusion. It creates an 800 x 600 viewport after   setting up the model, view, and projection matrices and binding the vertices and texture coordinates. 
# It includes a light which has controls for rotation and intensity as well as object translation, rotation and scaling. The object is semi transparent with emissive and specular qualities as well. 
# The controls include:
# Rotate object: left/right for y rotation, up down for x axis rotation, q/e for scale, w/s for y position, a/d for x position and z/x for z rotation. 
# The light controls don't work very well but i, k, j, l, n, m for xyz rotation. +/- control light intensity. 
########################################################################################################################################################################################
...
textures_dir = os.path.join(current_dir, r'Textures')

# Read all textures in the directory
for texture_file in os.listdir(textures_dir):
    ...
    if os.path.isfile(texture_path):
        ...
        print(f"Loaded {texture_file} with size {image.size}")
...
# Load texture files using relative paths
# DIFFUSE MAP

diffuse_texture_path = f"{textures_dir}/cgaxis_yellow_stained_glass_43_22_8K/yellow_stained_glass_43_22_diffuse.jpg"
diffuse_texture_image = pygame.image.load(diffuse_texture_path)
...
# ROUGHNESS MAP
roughness_texture_path = f"{textures_dir}/cgaxis_yellow_stained_glass_43_22_8K/yellow_stained_glass_43_22_roughness.jpg"
roughness_texture_image = pygame.image.load(roughness_texture_path)
...
# EMISSIVE MAP
emissive_texture_path = f"{textures_dir}/cgaxis_yellow_stained_glass_43_22_8K/yellow_stained_glass_43_22_emissive.jpg"
emissive_texture_image = pygame.image.load(emissive_texture_path)
...
glossiness_texture_path = f"{textures_dir}/cgaxis_yellow_stained_glass_43_22_8K/yellow_stained_glass_43_22_glossiness.jpg"
glossiness_texture_image = pygame.image.load(glossiness_texture_path)
...
metallic_texture_path = f"{textures_dir}/cgaxis_yellow_stained_glass_43_22_8K/yellow_stained_glass_43_22_metallic.jpg"
metallic_texture_image = pygame.image.load(metallic_texture_path)
...
normal_texture_path = f"{textures_dir}/cgaxis_yellow_stained_glass_43_22_8K/yellow_stained_glass_43_22_normal.jpg"
normal_texture_image = pygame.image.load(normal_texture_path)
...
opacity_texture_path = f"{textures_dir}/cgaxis_yellow_stained_glass_43_22_8K/yellow_stained_glass_43_22_opacity.jpg"
opacity_texture_image = pygame.image.load(opacity_texture_path)
...
occlusion_texture_path = f"{textures_dir}/cgaxis_yellow_stained_glass_43_22_8K/yellow_stained_glass_43_22_ao.jpg"
occlusion_texture_image = pygame.image.load(occlusion_texture_path)
